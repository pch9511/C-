...
namespace Franchise.Web.Models
{
    public class NoteRepository : INoteRepository
    {
        ...
        public int SaveOrUpdate(Note n, BoardWriteFormType formType)
        {
            ...
            p.Add("@RegiNum", value: n.RegiNum, dbType: DbType.String);
            ...
            switch(formType)
            {
                ...
                case BoardWriteFormType.Modify:
                    ...
                    p.Add("@Id", value: n.Id, dbType: DbType.String);
        ...
        public int GetCountAll()
        {
            try
            {
                return con.Query<int>(
                    "Select Count(*) From Note").SingleOrDefault();
            }
        ...
        {
            return
                con.Query<string>("Select FileName From Note Where Id = @Id",
        ...
        {
            string sql =
                "SELECT TOP 4 Id, Title, FileName, FileSize, FROM Note "
        ...
        {
            string sql = "SELECT TOP 5 Id, Title, Name, PostDate FROM Note "
                + " Order By Id Desc";
            return con.Query<Note>(sql).ToList();
        }
        ...
        {
            con.Execute(
                "Update Note Set Category = 'Notice' Where Id = @Id",
                new { Id = id });
        }
    }
}
