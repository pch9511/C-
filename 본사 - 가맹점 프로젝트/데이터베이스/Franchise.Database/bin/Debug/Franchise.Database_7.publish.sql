...
GO
/*
[dbo].[FranchiseInfo].[Check] 열이 삭제되므로 데이터 손실이 발생할 수 있습니다.
*/
...
GO
PRINT N'[dbo].[FranchiseInfo]에 대한 명명되지 않은 제약 조건 삭제 중...';


GO
ALTER TABLE [dbo].[FranchiseInfo] DROP CONSTRAINT [DF__Franchise__Check__24927208];
...
GO
ALTER TABLE [dbo].[FranchiseInfo] DROP COLUMN [Check];


GO
ALTER TABLE [dbo].[FranchiseInfo]
    ADD [Date] DATETIME DEFAULT GetDate() NULL;
